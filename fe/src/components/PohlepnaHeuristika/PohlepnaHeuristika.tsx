...
const PohlepnaHeuristika: React.FC = () => {
  return (
    <>
      <p>
        {tabIndent}Pohlepna heuristika za sortiranje po preokretima se zasniva
        ...
        <br />
        {tabIndent}Pohlepno sortiranje je prikazano na primeru u kojem se
      ...
      <p>
        {tabIndent}Matematički izraženo, element k u permutaciji{" "}
        <i>
        ...
        <br />
        {tabIndent}U slučaju preuređivanja mišjeg X hromozoma, na ovaj način se
