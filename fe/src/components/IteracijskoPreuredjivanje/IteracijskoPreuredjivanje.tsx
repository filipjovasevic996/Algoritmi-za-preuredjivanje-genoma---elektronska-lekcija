  ...
  return (
    <>
      <p>
        ...
        ljudskom genomu. Ljudi i miševi, prema navodima{" "}
        <i>Lawrence Livermore National Laboratory </i>, imaju približno isti
        broj gena i to oko 140000, od kojih je proučavano oko 4000. Skoro svaki
        gen koji je do sada pronađen u jednoj vrsti pronađen je u bliskom obliku
        u drugoj. Od približno 4000 gena koji su proučavani, manje od 10 se
        nalazi u jednoj vrsti, ali ne i u drugoj [5]. Najslikovitije prikazano,
        to bi izgledalo kao slaganje 280 kockica, tj. blokova sintenije, u
        slučaju čoveka u 23 para hromozoma, a u slučaju slaganja genoma miša, u
        20 parova hromozoma. Dostupnost genoma čoveka i miša utrla je put za
        razvoj algoritama za mapiranje sintenije velikih razmera i bolje
        razumevanje evolutivnih procesa..
        <br />
        ...
        sačuvao skoro sve gene. Na slici 2.1, prikazana je istorija hromozoma X.
      </p>
      ...
      <p>
        ...
        X hromozom u sedam iteracija, prikazana je na slici 2.2. Svaki blok
        ...
        iteraciji i ovaj oblik preuređenja se naziva <i>preokret</i>. Redosled
        blokova sintenije između tako označenih tačaka preuređivanja se okreće u
        svakoj iteraciji, dok se obrtanje vrši pojedinačno unutar svakog bloka
        sintenije.
        <br />
