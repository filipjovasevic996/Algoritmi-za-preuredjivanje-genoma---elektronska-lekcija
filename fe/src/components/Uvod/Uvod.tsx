...
const Uvod: React.FC = () => {
  return (
    <p>
      {tabIndent}Bioinformatika je jedna od najperspektivnijih i najbrže
      ...
      {tabIndent}Preuređivanje genoma je osnova evolucionih procesa i zasniva se
      na pomeranju njegovih fragmenata koji sadrže neodređeni broj gena,
