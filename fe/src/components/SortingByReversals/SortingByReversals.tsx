  ...
  return (
    <>
      <p>
        ...
        predaka i potomaka, treba pokušati da se nađe minimalni broj preokreta u
        skladu sa principom tzv. Okamove oštrice. Evolucija se možda neće uvek
        kretati najkraćim putevima, ali čak i kada to ne čini, broj koraka u
        pravom evolucionom scenariju se često približava broju koraka u
        najštedljivijem scenariju. Studije preuređivanja genoma obično
        zanemaruju dužinu blokova sintenije i predstavljaju hromozome potpisanim
        permutacijama. Svaki blok je označen brojem, kome se dodeljuje
        pozitivan/negativan predznak u zavisnosti od smera bloka. Broj elemenata
        u permutaciji određuje njenu dužinu. Kao što je prikazano na slici 2.2,
        ljudski i mišji X hromozomi mogu biti predstavljeni sledećim potpisanim
        ...
        kao što je prikazano na slici 3.1.
      </p>
